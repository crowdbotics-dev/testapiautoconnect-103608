...
## Project Structure
    ...
    ├── testapiautoconnect_103608  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_103608`
...
2. Clone this repo and `cd testapiautoconnect_103608`
